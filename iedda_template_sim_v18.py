...
# =============================================================================
#  EM だけで半減期を語るのは誤り。三元複合体は解離しても µM の ASO からすぐ再形成
#  されるので、律速は「解離」ではなく「化学反応 k_chem と再結合 k_rebind の競合」。
#      速度/接合部 = θ_AB * k_chem * k_rebind / (k_chem + k_rebind)
#      k_chem = k2 * EM,  k_rebind = k_on * [ASO]
#  k_chem << k_rebind なら平衡近似 θ_AB*k2*EM に、逆なら会合律速 θ_AB*k_on*[ASO]。
